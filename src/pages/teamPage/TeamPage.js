        ...
        <div className="teamPageContainer">
            ...
            <div className="teamContainer">
                <div className="teamMembers">
                    ...
                    <h4>piyusha.majgaonkar@gmail.com</h4>
                </div>
                <div className="teamMembers">
                    <img src="" alt="image"></img>
                    <h3>Aryan Das</h3>
                    <h4>itsaryandas15@gmail.com</h4>
                </div>
                <div className="teamMembers">
                    <img src="" alt="image"></img>
                    <h3>Sunaina Pal</h3>
                    <h4>sunainapal2006@gmail.com</h4>
                </div>
            </div>
            ...
            <div id="socialMedia">
                <div id="socialMediaPic">
                    <img src="" alt="image"></img>
                    <h3>Himal Bokka</h3>
                    <h4>Himalkumar2020@gmail.com</h4>
                </div>
